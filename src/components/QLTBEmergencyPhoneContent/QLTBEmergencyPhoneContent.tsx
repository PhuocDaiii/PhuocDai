    ...
    return (
        <div className="informationmain">
            ...
            <div className="center10101">
                        ...
                        <input className="anotherphonenumber"/>
                        <img src={daucong} className="anotheradd1"/>
                        <p className="anotherphonenumber11">Thêm số điện thoại khẩn cấp</p>
                        <p className="sdt991">Số điện thoại</p>
                        <p className="emergency451">Nhận cuộc gọi</p>
                        <input className="NUMBERPHONE10011"/>
                        <p className="sdt10011">079 359 3535</p>
                        <Link to="/phone22">
                        <img src={daucong} className="daucong10111"/>
                        </Link>
                        <p className="addnumberphone111">Thêm số điện thoại nhận cuộc gọi</p>
                        <p className="sdt7111">Số điện thoại</p>
                        <p className="sendmess11">Gửi tin nhắn</p>
                        <input className="NUMBERPHONE50011"/>
                        <p className="sdt7811">092 046 0505</p>
